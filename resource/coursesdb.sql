...
INSERT INTO `class` (`class_id`, `total`, `total_male`, `total_female`) VALUES
('17CTT4', 100, 90, 10);


INSERT INTO `course` (`course_id`, `subject_id`, `semester_id`, `lecturer`, `room`, `shift_id`) VALUES
('1', 'CSC13102', 1, 'Nguyễn Văn Khiết', 'F202', 15);


INSERT INTO `registration` (`student_id`, `course_id`, `subject_id`, `registration_time`) VALUES
('1712537', '1', 'CSC13102', '2021-03-06 12:05:37');


INSERT INTO `registration_sesstion` (`session_id`, `course_id`, `start_date`, `end_date`) VALUES
(1, '1', '2021-03-01', '2021-03-07');


INSERT INTO `semester` (`semester_id`, `name`, `school_year`, `start_date`, `end_day`) VALUES
(1, 'HK2', '2020-2021', '2021-03-09', '2021-06-18');
...
INSERT INTO `student` (`student_id`, `name`, `gender`, `dob`, `username`, `class_id`) VALUES
('1712537', 'Khoa Phan', 'Male', '1999-05-04', '1712537', '17CTT4');
